...
namespace CarRentalManager.Forms
{
    public partial class AvailableCarsForm : Form
    {
        ...
        { 
            ...
            decimal fuelConsumption = tbFuelConsuption.Text.ToString() == ""? 90: decimal.Parse(tbFuelConsuption.Text.ToString());// if i input number(or another wrong data) with dott it throws exception
